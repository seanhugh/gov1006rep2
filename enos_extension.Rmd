...
ggplot(tidy_coef2, aes(x = term, y = estimate)) +
  ...
  labs(subtitle = "This graph shows the output of the strat_glm function on the projects dataset. It can be seen that the treatment condition has the largest impact of any of the given variables.")
