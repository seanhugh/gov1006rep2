...
I use the Harvard Dataverse data to replicate figures from the paper ["Causal Effect of Intergroup Contact on Exclusionary Attitudes"](https://scholar.harvard.edu/files/renos/files/enostrains.pdf)[1].

Always great to have an abstract!
...
# Beautiful table and thorough notes. This is great work.
...
# Again, excellent work on the table
...
# Notes like these are good to have
...
Thanks for having a references section!

Great notes for replicated tables and figure. Overall, excellent comments throughout original Enos code. Might be useful to include comments/notes from class explaining the more complicated parts of the code. Great work!
